package com.jm.contract.Configs;
...
public class ContractConfigImpl implements ContractConfig {
    ...
    private final String fileNameWeb;
    ...
    public ContractConfigImpl(Environment env) {
        fileNameJava = env.getProperty("contract.name.java");
        fileNameWeb = env.getProperty("contract.name.web");
    ...
    @Override
    public String getFileName(String typeOfConract) {
        if (typeOfConract.equals("java")) {
        return fileNameJava;
        }else return fileNameWeb;
    }
